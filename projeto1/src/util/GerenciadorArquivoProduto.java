...
public abstract class GerenciadorArquivoProduto {
    ...
    protected static final String NOME_ARQUIVO_SERIALIZADO = FOLDER_NAME+File.separator+"produto_";
    protected static final String ARQUIVO_BANCO_DADOS_XML = "produtos.xml";
